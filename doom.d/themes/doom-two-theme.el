;;; doom-two-theme.el --- inspired by dark+ Theme by equinusocio -*- lexical-binding: t; no-byte-compile: t; -*-
(require 'doom-themes)
...
(defcustom doom-two-blue-modeline nil
...
(def-doom-theme doom-two
  ...
  ((bg         '("#1e1e1e" "#1e1e1e" nil))
   ...
   ;; custom categories
   (modeline-bg     (if doom-two-blue-modeline base6 base3))
  ...
  ((lazy-highlight :background base4 :foreground fg :distant-foreground fg :weight 'bold)
   ...
   ;;;; doom-modeline
   (doom-modeline-bar :background (if doom-two-blue-modeline base6 base3))
